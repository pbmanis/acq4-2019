...
#        print 'readparsupdate, calling analyze spikes'
    ...
    def analyzeSpikes(self):
        ...
        # print('datamode: ', self.Clamps.data_mode in self.dataModel.ic_modes)
        # print(type(self.Clamps.data_mode), self.Clamps.data_mode)
        # print(type(self.dataModel.ic_modes[0]), self.dataModel.ic_modes[0])
