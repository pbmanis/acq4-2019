...
# licensing of 'acq4/util/FileLoader/template.ui' applies.
#
...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.setDirBtn.setText(QtWidgets.QApplication.translate("Form", "Set Base Dir ->", None, -1))
        self.loadBtn.setText(QtWidgets.QApplication.translate("Form", "Load File ->", None, -1))
        self.clearBtn.setText(QtWidgets.QApplication.translate("Form", "Clear", None, -1))
        self.label.setText(QtWidgets.QApplication.translate("Form", "Notes:", None, -1))
