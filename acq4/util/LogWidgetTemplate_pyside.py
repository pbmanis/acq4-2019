...
# licensing of 'acq4/util/LogWidgetTemplate.ui' applies.
#
...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.exportHtmlBtn.setText(QtWidgets.QApplication.translate("Form", "Export HTML", None, -1))
        self.filterTree.headerItem().setText(0, QtWidgets.QApplication.translate("Form", "Display:", None, -1))
        __sortingEnabled = self.filterTree.isSortingEnabled()
        self.filterTree.setSortingEnabled(False)
        self.filterTree.topLevelItem(0).setText(0, QtWidgets.QApplication.translate("Form", "Current directory only", None, -1))
        self.filterTree.topLevelItem(1).setText(0, QtWidgets.QApplication.translate("Form", "All message types:", None, -1))
        self.filterTree.topLevelItem(1).child(0).setText(0, QtWidgets.QApplication.translate("Form", "user", None, -1))
        self.filterTree.topLevelItem(1).child(1).setText(0, QtWidgets.QApplication.translate("Form", "status", None, -1))
        self.filterTree.topLevelItem(1).child(2).setText(0, QtWidgets.QApplication.translate("Form", "warning", None, -1))
        self.filterTree.topLevelItem(1).child(3).setText(0, QtWidgets.QApplication.translate("Form", "error", None, -1))
        self.filterTree.setSortingEnabled(__sortingEnabled)
        self.label_2.setText(QtWidgets.QApplication.translate("Form", "Low", None, -1))
        self.label.setText(QtWidgets.QApplication.translate("Form", "Importance Filter:", None, -1))
        self.label_3.setText(QtWidgets.QApplication.translate("Form", "High", None, -1))
